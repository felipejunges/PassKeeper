...
public class InputDialog : Dialog
{
    ...
    // Add optional isPassword parameter (default false)
    public InputDialog(Window parent, string title, string initial = "", bool isPassword = false) : base(title, parent, DialogFlags.Modal)
    {
